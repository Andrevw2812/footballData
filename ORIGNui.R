...
navbarPage(theme = shinytheme("flatly"),
  ...
  tabPanel(
    "Match Selections - ReLay",
    fluidPage(
      fluidRow(
        column(6,
               h2("Match Analysis"), 
               h5("Matches Analyzed for Suitability of Laying Leading Team after Scoring"), offset = 3, align = "center")
      )
  ...
  tabPanel(
    ...
    fluidPage(
      fluidRow(
        column(6,
               h2("League Goal Overview"), offset = 3, align = "center")
      ),
      fluidRow(hr()),
      fluidRow(
        column(6, 
